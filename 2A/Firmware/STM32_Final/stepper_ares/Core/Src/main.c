...
//		int value_step = atoi(value_step_char);
	...
	//		}
	//		// 1 : monte
	//		else if(HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_6) == GPIO_PIN_SET && HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_7) == GPIO_PIN_RESET)
	//		{
	//			if (switch_mot == 0) // moteur bas
	//			{
	//				HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, GPIO_PIN_RESET);
	//				__HAL_TIM_SET_COMPARE(&htim3, TIM_CHANNEL_1, 499);
	//			}
	...
	//		}
	//		// 2 : descend
	//		else if(HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_6) == GPIO_PIN_RESET && HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_7) == GPIO_PIN_SET)
	//		{
	//			if (switch_mot == 0) // moteur bas
	//			{
	//				HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, GPIO_PIN_SET);
	...
	//
	//		// 3 : switch moteur
	//		else if(HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_6) == GPIO_PIN_SET && HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_7) == GPIO_PIN_SET){
	//			switch_mot = 1 - switch_mot;
	//		}
	//
	//
	...
	//	  // Sens horaire
	//	  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, GPIO_PIN_RESET);
	//	  __HAL_TIM_SET_COMPARE(&htim3, TIM_CHANNEL_1, 0); // Ajuster la vitesse, 500
	//
	//	  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_9, GPIO_PIN_RESET);
	//	  __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_3, 0);
